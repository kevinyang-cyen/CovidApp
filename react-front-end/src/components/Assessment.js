    ...
    <main className='assessment'>
      <Tabs defaultActiveKey="Self-Assessment Resources" id="uncontrolled-tab-example">
        <Tab eventKey="Self-Assessment Resources" title="Self-Assessment Resources">
          <Card>
            <ListGroup variant="flush">
              <ListGroup.Item className="btn-light canada"><a href="https://ca.thrive.health/covid19/en">Government of Canada</a></ListGroup.Item>
        ...
        <Tab eventKey="Restrictions & Guidelines" title="Restrictions & Guidelines">
          <Card>
            <ListGroup variant="flush">
              <ListGroup.Item className="btn-light canada"><a href="https://www.canada.ca/en/public-health/services/diseases/2019-novel-coronavirus-infection/latest-travel-health-advice.html/">Government of Canada</a></ListGroup.Item>
